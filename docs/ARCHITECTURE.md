...
![System overview and trust boundaries — internet, trust edge, application trust zone, data/state/object zones, external services](assets/diagrams/architecture-trust-boundaries.png)
