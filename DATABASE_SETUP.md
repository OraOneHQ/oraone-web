...
| `agents`               | AI workers. Columns: `id, organization_id, name, description, type, status, model, system_prompt, avatar_url, created_by_user_id, …`. `type` ∈ `{chat, whatsapp, sales, support}`. | ✅ |
