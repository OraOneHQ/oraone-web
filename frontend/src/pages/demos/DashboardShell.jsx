...
const CONVERSATIONS = [
  ...
  { name: "Aisha Khan", q: "Can I book a demo call?", channel: "SMS", icon: MessageCircle, agent: "Scheduling Bot", status: "Booked", time: "14m" },
...
const TOP_AGENTS = [
  ...
  { name: "Scheduling Bot", convos: 221, pct: 54 },
...
export default function DashboardShell({ theme: t }) {
  ...
  const chMap = { Web: t.channels[0], WhatsApp: t.channels[1], SMS: t.channels[2], Email: t.channels[3] };
  const statusMap = {
    Resolved: "#16A34A",
    Active: t.brand,
    Booked: "#7C3AED",
