...
const CHANNELS = [
  ...
  { name: "SMS", value: 17, color: "#7C3AED" },
...
const CONVERSATIONS = [
  ...
  { name: "Aisha Khan", q: "Can I book a demo call?", channel: "SMS", icon: MessageCircle, agent: "Scheduling Bot", status: "Booked", tone: "#7C3AED", bg: "#F5F3FF", time: "14m" },
...
const TOP_AGENTS = [
  ...
  { name: "Scheduling Bot", convos: 221, pct: 54, color: "#7C3AED" },
