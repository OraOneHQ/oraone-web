    ...
    <div className="space-y-6" data-testid="widgets-page">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-dashed border-[#CBD5E1] rounded-2xl p-12 text-center">
          ...
          <button
            onClick={() => setEditing("new")}
            className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#2563EB] text-white text-sm font-semibold"
          >
      ...
      >
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-[#EEF2F7] sticky bottom-0 bg-white">
          ...
          <button
            onClick={submit}
            disabled={saving}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-50 text-white text-sm font-semibold"
          >
