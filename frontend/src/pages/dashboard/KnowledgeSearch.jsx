...
export default function KnowledgeSearch() {
  ...
  const kpis = useMemo(
    () => [
      ...
      { icon: FileText, color: "#7C3AED", label: "Documents", value: stats?.documents ?? "—" },
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-2xl p-4 space-y-3">
        <div className="flex gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-50 text-white text-sm font-semibold"
          >
