...
function SessionsSection() {
  ...
  // Cognito issues stateless JWTs, so "sign out everywhere" maps to a real
  // global sign-out that revokes every refresh token for this account —
  // including this one. We confirm, then drop the user back to the login page.
