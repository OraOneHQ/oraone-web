...
import { ArrowLeft, ArrowRight, PlayCircle, Trash2, Check, Loader2, UploadCloud, FileText, Plug } from "lucide-react";
          ...
          <motion.div key={tab} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="p-6 sm:p-8 rounded-2xl bg-white border border-[#E2E8F0]">
            ...
            {tab === "review" && (
              <div>
                ...
                <button onClick={deploy} className="mt-6 px-5 py-3 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-sm font-semibold" data-testid="agent-deploy-btn">Deploy Agent</button>
              </div>
            )}
            ...
            <div className="mt-8 flex items-center justify-between border-t border-[#F1F5F9] pt-5">
              ...
              {tab !== "review" && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-5 py-2 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
    ...
    <div className="space-y-5">
      ...
      >
        ...
        <button
          ...
          disabled={uploading}
          className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-sm disabled:opacity-60"
        >
