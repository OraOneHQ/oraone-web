...
export default function Websites() {
  ...
  const kpis = useMemo(() => {
    ...
    return [
      ...
      { icon: FileText, color: "#7C3AED", label: "Pages Indexed", value: pages },
    ];
  }, [items]);
    ...
    <div className="space-y-6" data-testid="websites-page">
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-50 text-white text-sm font-semibold shadow-[0_8px_24px_-8px_rgba(37,99,235,0.5)]"
      ...
      >
        ...
        <div className="flex justify-end gap-2 px-6 py-4 border-t border-[#E2E8F0]">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-50 text-white text-sm font-semibold"
          >
