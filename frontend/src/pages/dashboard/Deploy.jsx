            ...
            <div className="flex items-center gap-2">
              ...
              {deploy.deploy_status === "live" ? (
                ...
                <button
                  ...
                  disabled={publishing}
                  className="inline-flex items-center gap-1.5 rounded-xl bg-[#2563EB] px-3.5 py-2 text-sm font-semibold text-white hover:bg-[#1D4ED8] disabled:opacity-60"
                >
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        {c.channel === "voice" && c.phone_number ? (
                          <p className="text-[12px] text-[#334155] mt-1 font-mono">{c.phone_number}</p>
                        ) : null}
                      </div>
                    </div>
                    <div className="pt-1">
