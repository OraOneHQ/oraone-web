        ...
        <div className="hidden lg:flex rounded-2xl bg-white border border-[#E2E8F0] flex-col overflow-hidden">
          <div className="p-3 border-b border-[#E2E8F0] space-y-2.5">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-sm font-semibold shadow-[0_8px_24px_-8px_rgba(37,99,235,0.5)] transition-colors"
            >
              ...
              <div className="border-t border-[#E2E8F0] p-3 sm:p-4">
                ...
                <div className="flex items-end gap-2">
                  ...
                  <button
                    ...
                    className="size-12 shrink-0 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-40 disabled:cursor-not-allowed text-white grid place-items-center shadow-[0_8px_24px_-8px_rgba(37,99,235,0.5)] transition-colors"
  ...
  return (
    <div className="h-full grid place-items-center p-8 text-center">
      <div className="max-w-sm">
        ...
        <button
          onClick={onNewChat}
          className="mt-5 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-sm font-semibold shadow-[0_8px_24px_-8px_rgba(37,99,235,0.5)]"
        >
          <Plus size={16} /> New Chat
        </button>
      </div>
