...
export default function Login() {
  ...
  return (
    <AuthShell cardTestId="login-form">
      <h2 className="text-center text-3xl font-extrabold tracking-tight text-[#0F172A]">Welcome Back</h2>
      ...
      <form className="mt-8 space-y-5" onSubmit={handleSignIn}>
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/forgot-password" className="text-sm font-semibold text-[#6366F1] hover:underline">
            Forgot Password?
          </Link>
        </div>
