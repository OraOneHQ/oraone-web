...
import { Lightbulb, MessageCircleQuestion, AlertTriangle, BookOpen, Clock } from "lucide-react";
import {
...
const areaTone = { knowledge: "blue", prompt: "purple", voice: "indigo", workflow: "amber" };
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <StatCard label="Long calls (>10m)" value={fmtNum(data.long_calls)} icon={Clock}
          tone={data.long_calls ? "amber" : "slate"} />
      </div>
