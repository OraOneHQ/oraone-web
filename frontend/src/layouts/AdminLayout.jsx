...
function TopBar({ onMenu, onSearch, admin }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center gap-3 px-4 py-3 sm:px-6"
      ...
      <button className="lg:hidden" onClick={onMenu} style={{ color: t.sub }}><Menu className="h-5 w-5" /></button>
      ...
      <div className="ml-auto flex items-center gap-2">
        <button onClick={toggle} className="grid h-9 w-9 place-items-center rounded-xl" style={{ background: t.glassSolid, border: `1px solid ${t.line}`, color: t.sub }}>
