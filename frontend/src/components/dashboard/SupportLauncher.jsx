          ...
          >
                ...
                <div className="space-y-1.5 pt-1" data-testid="support-suggestions">
                  {suggestions.slice(0, 3).map((s, i) => (
                    <button
                      ...
                      type="button"
                      onClick={() => send(s)}
                      className="block w-full truncate rounded-xl border border-[#E2E8F0] bg-white px-3 py-2 text-left text-[12px] font-medium text-[#334155] transition hover:border-[#C7D2FE] hover:bg-[#EEF2FF]"
                    >
                      {s}
                    </button>
                  ))}
            ...
            >
              <input
                ...
                className="flex-1 rounded-xl border border-[#E2E8F0] px-3 py-2 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#4F46E5]/30 disabled:opacity-60"
              />
              <button
                type="submit"
