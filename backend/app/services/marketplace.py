...
* ``voice_pack``     — a curated voice/persona preset.
...
CATEGORIES = [
    ...
    {"value": "voice_pack", "label": "Voice Packs"},
...
LISTINGS: list[dict[str, Any]] = [
    ...
    # ── voice packs ──
    {
        "slug": "voice-warm-female-en", "name": "Warm Female (EN)",
        "category": "voice_pack", "summary": "A natural, warm female voice for friendly support and sales.",
        "icon": "🎙️", "tags": ["english", "female", "warm"], "author": "OraOne", "featured": False,
        "blueprint": {"voice": "emma", "language": "en", "stability": 0.45, "style": 0.4},
    },
    {
        "slug": "voice-confident-male-en", "name": "Confident Male (EN)",
        "category": "voice_pack", "summary": "A clear, confident male voice for outbound and B2B calls.",
        "icon": "🎙️", "tags": ["english", "male", "confident"], "author": "OraOne", "featured": False,
        "blueprint": {"voice": "daniel", "language": "en", "stability": 0.5, "style": 0.3},
    },
    {
        "slug": "voice-friendly-hinglish", "name": "Friendly Hinglish",
        "category": "voice_pack", "summary": "A natural Hindi-English blend for Indian audiences.",
        "icon": "🎙️", "tags": ["hindi", "hinglish", "india"], "author": "OraOne", "featured": True,
        "blueprint": {"voice": "neerja", "language": "hi", "stability": 0.45, "style": 0.45},
    },
    # ── integrations ──
    {
    ...
    # ── workflows ──
    {
        ...
        "category": "workflow", "summary": "Auto-follow-up new leads across call, WhatsApp and email.",
        "icon": "⚡", "tags": ["automation", "lead-gen"], "author": "OraOne", "featured": True,
        "blueprint": {"trigger": "lead.created", "steps": ["wait_1h", "call", "whatsapp", "email"]},
    },
    {
        "slug": "workflow-missed-call", "name": "Missed Call Rescue",
        "category": "workflow", "summary": "Instantly text back and schedule a callback for missed calls.",
        "icon": "⚡", "tags": ["automation", "voice"], "author": "OraOne", "featured": False,
        "blueprint": {"trigger": "call.missed", "steps": ["sms_callback_link", "create_callback"]},
    },
]
